  ...
  return (
    <header className='text-black max-w-screen-2xl container mx-auto x1:px-24 px-4 bg-bigbg'>
      <nav className='flex justify-between items-center py-6'>
        ...
        <div className='font-medium text-black space-x-5 hidden lg:block'>
          <Link to="/login" className='py-2 px-5 border rounded bg-blue-600  hover:bg-spark'>Login</Link>
          <Link to="/register" className='py-2 px-5 border rounded bg-blue-600  hover:bg-spark'>Register</Link>
        </div>
